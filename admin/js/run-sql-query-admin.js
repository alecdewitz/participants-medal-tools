  ...
  function resetDatabase() {
    ...
    if (resetConfirm && $('#participants_database_fields').val()) {
      ...
      resetConfirm = confirm(
        'Are you sure you want to update the options for the database?'
      );

      if (resetConfirm && $('#options_db').val()) {
        // update options
        $('#query').val(
          'UPDATE ' +
            $('#options_db').val() +
      ...
      resetConfirm = confirm(
        'Are you sure you want to update the options for the cms database?'
      );
